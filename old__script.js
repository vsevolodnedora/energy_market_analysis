 ...
 */
async function setupDetailsToggleEvent({ detailsSelector, stackedChartNum, createdKey, instanceKey }) {
 ...
 */
async function defineResetChartFunction({ stackedChartNum, createdKey, instanceKey }) {
 ...
 */
async function defineUpdateChartFunction({ stackedChartNum, getConfigFunction }) {
 ...
 */
async function setupDescriptionToggleEvent({descriptionToggleId, descriptionContainerId, descLoadedKey, filePrefix }) {
...
function setupStackedChartEvents({
  stackedChartNum, descriptionToggleId, descriptionContainerId, descLoadedKey, createdKey, instanceKey,
  detailsSelector, filePrefix, getConfigFunction
}) {
